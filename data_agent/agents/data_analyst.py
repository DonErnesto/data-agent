...
from ..agent.actions import list_files, load_dataframe, call_dataframe_method, merge_dataframes, call_column_method
from ..agent.actions import ListFilesParams, LoadDataFrameParams, CallDataFrameMethodParams, MergeDataFramesParams, CallColumnMethodParams
...
goals = [
    ...
    """),
    Goal(priority=1, name="Do a deep-dive in the columns to give a high-quality QA report", description="""
    ...
    - Note that previous and latest data is best compared by merging these dataframes on the "sbti_id" column
    - You have many standard pandas function at your disposal, like "describe", "mean", "max", "min", etc.
    - Continue searching for changes until you have a complete analysis, and a trustworthy summary of all notable changes. 
    """),
    Goal(priority=1, 
...
user_input = """
You are an AI agent that can perform tasks by using available tools to answer questions about files present in the environment.
